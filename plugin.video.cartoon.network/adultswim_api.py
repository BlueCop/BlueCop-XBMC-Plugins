...
SERVER_TIME_URL = "http://cnvideosvc2.cartoonnetwork.com/svc/services/getServerTime?networkName=CN2"
EPISODES_BY_SHOW_URL = "http://cnvideosvc2.cartoonnetwork.com/svc/episodeSearch/getEpisodesByShow?networkName=CN2&id=%s&limit=500&offset=0"
EPISODES_BY_IDS_URL = "http://cnvideosvc2.cartoonnetwork.com/svc/episodeSearch/getEpisodesByIDs?ids=%s&networkName=CN2"
...
class AdultSwim(object):
	...
	def getEpisodesByShow(self, id):
		response = self._request( EPISODES_BY_SHOW_URL % (id) )
		xml = ElementTree(fromstring(response))
		episodes = []
